...
public enum Rotation
{
  ...
  public Point2D getCenterOfRotation( double x, double y, double w, double h )
  {
    switch( this )
    {
      case CW_90:  return new Point2D.Double( x + w, y );
      case CW_180: return new Point2D.Double( x + w, y + h );
      case CW_270: return new Point2D.Double( x,     y + h );
      default:     return new Point2D.Double( x,     y );
    }
  }
  ...
  public Point2D getOrigin( double cx, double cy, double tw, double th )
  {
    switch( this )
    {
      case CW_90:  return new Point2D.Double( cx+tw, cy );
      case CW_180: return new Point2D.Double( cx+tw, cy+th );
      case CW_270: return new Point2D.Double( cx,    cy+th );
      default:     return new Point2D.Double( cx,    cy );
    }
  }
}
